  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* ── Favicon ── */}
        <link rel="icon" type="image/svg+xml" href="/prompt-gallery-saas/favicon.svg?v=2" />
        <link rel="icon" type="image/png" sizes="32x32" href="/prompt-gallery-saas/favicon.ico?v=2" />
        <link rel="apple-touch-icon" sizes="192x192" href="/prompt-gallery-saas/icons/icon-192.png?v=2" />
        ...
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap" rel="stylesheet" media="print" />
        <script dangerouslySetInnerHTML={{ __html: `document.querySelector('link[href*="fonts.googleapis.com/css2?family=Inter"]').media='all'` }} />
        <noscript>
          <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap" rel="stylesheet" />
        </noscript>

        {/* ── Critical image preload (OG image) ── */}
        <link rel="preload" href="/prompt-gallery-saas/images/attack-on-titan.jpg" as="image" />
