...
export const DetailClient = ({ params, mockPrompt, userTier }: { params: { id: string }, mockPrompt: any, userTier: string }) => {
  const { t } = useI18n();
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <FeatureGate isProRequired={true} userTier={userTier}>
              <div className="grid grid-cols-3 gap-4">
                {[
                  { label: t('scores.realism'), score: 98, color: 'text-emerald-400' },
                  { label: t('scores.creative'), score: 82, color: 'text-indigo-400' },
                  { label: t('scores.complexity'), score: 75, color: 'text-amber-400' },
                ].map(stat => (
